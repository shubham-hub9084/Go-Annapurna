...
> [!WARNING]
> This application currently uses a local JSON file (`users.json`) or `localStorage` (Mock Mode) for data persistence. **Passwords are stored in plain text.** For a production environment, you must:
>
