        ...
        <div className="min-h-screen w-full flex bg-background">
            ...
            <div className="hidden lg:flex w-1/2 relative bg-gray-900 overflow-hidden items-center justify-center">
                ...
                <div className="relative z-10 p-12 text-center text-white max-w-lg">
                    <h2 className="text-5xl font-['Montserrat',sans-serif] font-bold mb-6">Shubham the Family</h2>
                    <p className="text-xl text-gray-200 font-light leading-relaxed">
                        Create an account to unlock exclusive deals, track orders, and experience the best of Indian cuisine.
                    </p>
                </div>
            </div>
