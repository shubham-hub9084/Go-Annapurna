                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        >
                            ...
                            <form id="checkout-form" onSubmit={handlePlaceOrder} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input required type="text" className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition-all" />
                                </div>
                                <div className="space-y-2">
                                ...
                                <div className="md:col-span-2 space-y-2">
                                    ...
                                    <input required type="text" className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition-all" placeholder="House No, Street Name" />
                                </div>
                                <div className="space-y-2">
                                ...
                                <div className="md:col-span-2 space-y-2">
                                    ...
                                    <input required type="tel" className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 outline-none transition-all" />
                                </div>
                            </form>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <button
                                    ...
                                    className={`p-4 rounded-xl border-2 flex items-center gap-3 transition-all ${paymentMethod === "card" ? "border-orange-500 bg-orange-50" : "border-gray-100 hover:border-orange-200"}`}
                                >
                                    <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-orange-600 text-xl shadow-sm">
                                        <RiBankCardLine />
                                    </div>
                                    <div className="text-left">
                                        <span className="block font-bold text-gray-900">UPI / Card</span>
                                ...
                                <button
                                    ...
                                    className={`p-4 rounded-xl border-2 flex items-center gap-3 transition-all ${paymentMethod === "cod" ? "border-orange-500 bg-orange-50" : "border-gray-100 hover:border-orange-200"}`}
                                >
                                    <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center text-green-600 text-xl shadow-sm">
                                        <RiMoneyDollarCircleLine />
                                    </div>
                                    <div className="text-left">
                                        <span className="block font-bold text-gray-900">Cash on Delivery</span>
                                        <span className="text-xs text-gray-500">Pay when you get it</span>
                                    </div>
                    ...
                    <div className="lg:col-span-1">
                        <motion.div
                            ...
                            className="bg-white p-6 rounded-2xl shadow-lg border border-orange-100 sticky top-24"
                        >
